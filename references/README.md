...
1. Extrair **ideias** (layout, hierarquia, copy)  
2. **Reimplementar** com tokens e padrões Lector em `pages/`  
3. Se algo virar asset oficial, copiar curado para `assets/media/<slug>/` ou `assets/brand/`  
